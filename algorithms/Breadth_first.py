...
def breadth_first_route(main_array, stations, critical_stations, trains, iterations):
	...
	try:
		for i in range(iterations):
			...
			# write calculated highscore of current set of starting stations to csv
			with open("./csv/breadth_first_all_scores.csv", 'a', newline='') as f:
				writer = csv.writer(f)
				writer.writerow([round(final_score, 5)])	
			...
			with open("./csv/breadth_first_highscores.csv", 'a', newline='') as f:
				writer = csv.writer(f)
